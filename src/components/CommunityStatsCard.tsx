...
export default function CommunityStatsCard({ title, creator }: Props) {
  ...
  return (
    <div className="mb-6 flex items-center gap-3 rounded-xl border border-[#2a2a2a] bg-[#161616] px-4 py-3">
      ...
      <div className="flex items-center gap-3 text-sm">
        <span className="text-[#888888]">
          Toplulukta{" "}
          <span className="font-semibold text-[#f0ede8]">{stats.count} kişi</span> notladı
        </span>
        {stats.avgRating > 0 && (
          <>
            ...
            <span className="flex items-center gap-1 text-[#888888]">
              ...
              <span className="font-semibold text-[#f0ede8]">{stats.avgRating}</span>
              <span className="text-[#555555]">/ 5 ort.</span>
            </span>
          </>
        )}
      </div>
