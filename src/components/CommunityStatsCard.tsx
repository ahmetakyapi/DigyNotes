...
export default function CommunityStatsCard({ title, creator }: Props) {
  ...
  return (
    <div className="mb-6 flex items-center gap-3 rounded-xl border border-[var(--border)] bg-[var(--bg-card)] px-4 py-3">
      <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#c4a24b]/10">
        <svg className="h-4 w-4 text-[#c4a24b]" fill="currentColor" viewBox="0 0 20 20">
        ...
        {stats.avgRating > 0 && (
          <>
            ...
            <span className="flex items-center gap-1 text-[var(--text-secondary)]">
              <svg className="h-3.5 w-3.5 text-[#c4a24b]" fill="currentColor" viewBox="0 0 20 20">
