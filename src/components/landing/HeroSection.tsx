  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 hidden overflow-hidden sm:block">
        <motion.div
          className="absolute right-[12%] top-[18%] h-20 w-20 rounded-full border border-[rgba(196,162,75,0.12)]"
          animate={{ rotate: 360 }}
          transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
        />
        <motion.div
          className="absolute bottom-[22%] left-[8%] h-6 w-6 rotate-45 rounded-sm border border-[rgba(129,140,248,0.15)]"
          animate={{ y: [0, -20, 0], opacity: [0.3, 0.7, 0.3] }}
          transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute right-[22%] top-[65%] h-3 w-3 rounded-full"
          style={{ background: "rgba(196,162,75,0.15)" }}
          animate={{ y: [0, -15, 0], scale: [1, 1.5, 1] }}
          transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 1 }}
        />
        <motion.div
          className="absolute bottom-[30%] left-[18%] h-32 w-32 rounded-full border border-[rgba(80,160,120,0.06)]"
      ...
      >
        ...
        <div className="flex flex-col items-center">
          ...
          <motion.p
            className="mx-auto max-w-[322px] px-2 py-1 text-center text-[0.96rem] font-medium leading-[1.72] text-[var(--text-secondary)] [text-wrap:balance] sm:mb-2 sm:max-w-3xl sm:px-0 sm:py-0 sm:text-[1.08rem] sm:leading-[1.86] xl:max-w-4xl xl:text-[1.18rem] 2xl:max-w-[54rem] 2xl:text-[1.24rem]"
        ...
        >
          ...
          <MagneticButton className="w-[86%] self-center sm:w-auto sm:self-auto">
            <Link
              href="/login"
              className="dn-cta-ghost block w-full rounded-[1.6rem] border border-[var(--border)] py-[9px] text-center text-[clamp(0.88rem,3.6vw,1.02rem)] font-medium tracking-[0.01em] text-[var(--text-primary)] backdrop-blur-sm transition-all duration-300 hover:bg-[var(--surface-strong)] sm:rounded-2xl sm:px-9 sm:py-[11px] sm:text-[14px] 2xl:px-12 2xl:py-[17px] 2xl:text-[16px]"
