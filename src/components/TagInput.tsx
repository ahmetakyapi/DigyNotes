...
export default function TagInput({ value, onChange, disabled }: TagInputProps) {
  ...
  return (
    <div className="space-y-2">
      <div
        className="flex min-h-[46px] cursor-text flex-wrap gap-1.5 rounded-lg border border-[var(--border)] bg-[var(--bg-card)] p-2 transition-colors focus-within:border-[#10b981]/50"
