...
export default function ProfileError({ reset }: { reset: () => void }) {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      ...
      <h2 className="mb-2 text-lg font-semibold text-[var(--text-primary)]">Profil yüklenirken bir hata oluştu</h2>
      <p className="mb-6 max-w-sm text-sm text-[var(--text-muted)]">
        Sayfa beklenmedik bir hatayla karşılaştı. Tekrar deneyebilir veya keşfet sayfasına gidebilirsin.
      </p>
