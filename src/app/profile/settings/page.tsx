        ...
        <div className="mx-auto flex max-w-2xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="rounded-lg bg-gradient-to-r from-[#10b981] via-[#059669] to-[#047857] px-6 py-2.5 text-sm font-semibold text-white shadow-[0_4px_14px_rgba(16,185,129,0.28)] transition-all hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-40"
            >
