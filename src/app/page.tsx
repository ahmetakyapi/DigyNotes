  ...
  return (
    <div className="flex min-h-screen flex-col overflow-x-hidden bg-[var(--bg-base)] text-[var(--text-primary)]">
      ...
      {/* ══════════════════════════════════════
          FOOTER
      ══════════════════════════════════════ */}
      <footer className="relative border-t border-[var(--border)] px-4 py-5 sm:px-6 sm:py-6">
        <div
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-2 text-xs text-[var(--text-muted)] sm:grid-cols-[1fr_auto_1fr] sm:items-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 justify-self-end transition-colors duration-200 hover:text-[var(--text-primary)]"
          >
