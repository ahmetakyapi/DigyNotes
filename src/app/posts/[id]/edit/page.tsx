...
const inputBase =
  "w-full rounded-lg border border-[var(--border)] bg-[var(--bg-card)] px-3.5 py-2.5 text-[16px] sm:text-sm text-[var(--text-primary)] placeholder:text-[var(--text-muted)] transition-all focus:outline-none focus:border-[#10b981]/60 focus:ring-1 focus:ring-[#10b981]/15";
const labelClass =
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="min-w-0">
              <div className="mb-1 flex flex-wrap items-center gap-2">
                ...
                <span className="inline-flex items-center rounded-full border border-[#10b981]/25 bg-[#10b981]/10 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-[var(--gold)]">
                  Düzenleniyor
                </span>
                {isDirty && (
              ...
              {image && (
                <div className="mt-3 overflow-hidden rounded-xl border border-[var(--border-subtle)] bg-[var(--media-panel-bg)] shadow-[var(--shadow-soft)]">
                  <div className="relative h-36 w-full sm:h-48 lg:h-52 xl:h-56">
                    ...
                    />
                    <span className="absolute left-3 top-3 rounded-full border border-[#10b981]/30 bg-[var(--bg-overlay)] px-2.5 py-1 text-[10px] font-semibold text-[var(--gold)] backdrop-blur-md">
                      Kapak Önizleme
                    </span>
