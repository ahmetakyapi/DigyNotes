...
export default function RecommendedPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-[#f0ede8]">Senin İçin Öneriler</h1>
      ...
      {loading ? (
        ...
        <div className="flex min-h-[40vh] flex-col items-center justify-center text-center">
          ...
          <p className="mb-1 font-medium text-[#888888]">Henüz öneri yok.</p>
...
function RecommendedCard({ post }: { post: Post }) {
  return (
    <div className="group overflow-hidden rounded-2xl border border-[#1a1e2e] bg-[#0d0f1a] transition-all hover:border-[#2a3050]">
      ...
      {/* Body */}
      <div className="p-4">
        <h3 className="mb-0.5 line-clamp-1 font-semibold text-[#f0ede8] transition-colors group-hover:text-[#c9a84c]">
          {post.title}
        </h3>
