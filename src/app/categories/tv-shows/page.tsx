...
const tvShows = [
  ...
  },
  {
    ...
    years: "2015-2022",
    rating: "9.0",
    excerpt: "Breaking Bad'in spin-off'u olan dizi, Jimmy McGill'in Saul Goodman'a dönüşüm hikayesini anlatıyor...",
    slug: "/posts/better-call-saul",
    image: "https://m.media-amazon.com/images/M/MV5BZDA4YmE0OTYtMmRmNS00Mzk2LTlhM2MtNjk4NzBjZGE1MmIyXkEyXkFqcGdeQXVyMTMzNDExODE5._V1_.jpg"
  },
  {
    ...
    years: "2014-2024",
    rating: "8.9",
    excerpt: "Her sezonunda farklı bir suç hikayesini anlatan antoloji dizisi, karanlık ve gizemli atmosferiyle dikkat çekiyor...",
    slug: "/posts/true-detective",
    image: "https://m.media-amazon.com/images/M/MV5BMmRlYmE0Y2UtNDk2Yi00NzczLWEwZTEtZmE2OTcyYzcxYmU5XkEyXkFqcGdeQXVyNTMxMjgxMzA@._V1_.jpg"
  }
]
              ...
              <article className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-all duration-300">
                <div className="md:flex">
                  ...
                  <div className="md:w-2/3 p-8 flex flex-col">
                    ...
                    <p className="text-gray-600 leading-relaxed line-clamp-4">{show.excerpt}</p>
